...
% for Progression in potentielle Progressions:
% 	Erstelle Nodes für Anfangs- und Endakkord
% 	Erstelle gewichtete Kante zwischen den Nodes
% figure of (growing) graph
